...
<h3><?php echo $MOD_TOPICS['PICTURES']; ?></h3>
	...
	<td class="setting_fields">	
		...
		<tr><td>Zoom:</td><td><input type="text" name="w_zoom" id="w_zoom" size="4" value="<?php echo $w_zoom; ?>" style="width:40px; "></td><td><input type="text" name="h_zoom" id="h_zoom" size="4" value="<?php echo $h_zoom; ?>" style="width:40px; "></td></tr>
		<tr><td>View:</td><td><input type="text" name="w_view" id="w_view" size="4" value="<?php echo $w_view; ?>" style="width:40px; "></td><td><input type="text" name="h_view" id="h_view" size="4" value="<?php echo $h_view; ?>" style="width:40px; "></td></tr>
		<tr><td>Thumb:</td><td><input type="text" name="w_thumb" id="w_thumb" size="4" value="<?php echo $w_thumb; ?>" style="width:40px; "></td><td><input type="text" name="h_thumb" id="h_thumb" size="4" value="<?php echo $h_thumb; ?>" style="width:40px; "></td></tr>
		<tr><td>Zoom Class:</td><td colspan="2"><input type="text" name="zoomclass" id="zoomclass" size="20" value="<?php echo $zoomclass; ?>" style="width:100px; "></td></tr>
...
<h3><?php echo $TEXT['COMMENTS']; ?></h3>
	<table class="settingsleft" cellpadding="2" cellspacing="0" <?php if ($use_commenting < 0) echo ' style="display:none;"' ?>>		
		...
		<tr>
			...
			<td class="setting_fields"><input class="inputf" type="text" name="maxcommentsperpage" value="<?php echo $maxcommentsperpage; ?>" style="width: 10%;" maxlength="3" /></td>
		</tr>
